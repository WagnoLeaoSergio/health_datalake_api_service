...
├── health_datalake_api_service             # The main python package for the project
...
e.g: `cat health_datalake_api_service/VERSION` will get the project version without harming
